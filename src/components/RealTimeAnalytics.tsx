      ...
      <div className="border-b border-gray-200 p-3 sm:p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1">Monitor live user activity</p>
          </div>
          <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            <label className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm text-gray-700 cursor-pointer">
              <input
                type="checkbox"
                checked={autoRefresh}
      ...
      <div className="p-3 sm:p-6">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-4 sm:space-y-6">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Current Page Activity</h3>
              {pageActivity.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                  {pageActivity.map((item) => (
                    <div
                      key={item.page}
                      className="bg-gray-50 rounded-lg p-3 sm:p-4 border border-gray-200 hover:border-blue-300 transition-colors"
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex-1 min-w-0">
                          <p className="text-xs sm:text-sm font-mono text-gray-600 truncate">{item.page}</p>
                          <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{item.count}</p>
                ...
                <p className="text-center text-gray-500 py-8 text-sm">No active sessions</p>
              )}
            </div>
          </div>
        )}
            ...
            <div className="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
              {sessionsData && sessionsData.sessions.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">No active sessions with location data</p>
                </div>
              )}
            </div>
