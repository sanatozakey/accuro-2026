        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
              <a
                href="/"
                className="flex-1 sm:flex-none inline-flex items-center justify-center px-3 sm:px-4 py-2 border border-gray-300 text-xs sm:text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
              >
              ...
              <button
                onClick={logout}
                className="flex-1 sm:flex-none inline-flex items-center justify-center px-3 sm:px-4 py-2 border border-transparent text-xs sm:text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700"
              >
                Logout
              </button>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-3 sm:p-4 mb-6">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:flex lg:flex-wrap gap-2">
            <button
              ...
              className={`inline-flex items-center justify-center px-2 sm:px-4 py-2 border ${viewMode === 'table' ? 'border-blue-600 bg-blue-50 text-blue-600' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'} text-xs sm:text-sm font-medium rounded-md`}
            >
              <List className="h-4 w-4 sm:mr-2" />
              <span className="hidden sm:inline ml-1">List View</span>
              <span className="sm:hidden ml-1">List</span>
            </button>
            <button
              onClick={() => setViewMode('calendar')}
              className={`inline-flex items-center justify-center px-2 sm:px-4 py-2 border ${viewMode === 'calendar' ? 'border-blue-600 bg-blue-50 text-blue-600' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'} text-xs sm:text-sm font-medium rounded-md`}
            >
            ...
            <button
              ...
              className={`inline-flex items-center justify-center px-2 sm:px-4 py-2 border ${viewMode === 'logs' ? 'border-blue-600 bg-blue-50 text-blue-600' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'} text-xs sm:text-sm font-medium rounded-md`}
            >
            ...
            <button
              ...
              className={`inline-flex items-center justify-center px-2 sm:px-4 py-2 border ${viewMode === 'activityLogs' ? 'border-blue-600 bg-blue-50 text-blue-600' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'} text-xs sm:text-sm font-medium rounded-md`}
            >
            ...
            <button
              ...
              className={`inline-flex items-center justify-center px-2 sm:px-4 py-2 border ${viewMode === 'reviews' ? 'border-blue-600 bg-blue-50 text-blue-600' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'} text-xs sm:text-sm font-medium rounded-md`}
            >
            ...
            <button
              ...
              className={`inline-flex items-center justify-center px-2 sm:px-4 py-2 border ${viewMode === 'users' ? 'border-blue-600 bg-blue-50 text-blue-600' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'} text-xs sm:text-sm font-medium rounded-md`}
            >
            ...
            <button
              ...
              className={`inline-flex items-center justify-center px-2 sm:px-4 py-2 border ${viewMode === 'analytics' ? 'border-blue-600 bg-blue-50 text-blue-600' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'} text-xs sm:text-sm font-medium rounded-md`}
            >
            ...
            <button
              ...
              className={`inline-flex items-center justify-center px-2 sm:px-4 py-2 border ${viewMode === 'reports' ? 'border-blue-600 bg-blue-50 text-blue-600' : 'border-gray-300 bg-white text-gray-700 hover:bg-gray-50'} text-xs sm:text-sm font-medium rounded-md`}
            >
