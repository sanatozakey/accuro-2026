...
export function Testimonials() {
  ...
  return (
    <div className="w-full bg-gray-50 min-h-screen">
      ...
      {isAuthenticated && (
        <section className="py-6 sm:py-8 bg-gradient-to-br from-blue-50 to-indigo-50 border-b">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto">
              ...
              {!showForm ? (
                <button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 sm:py-4 px-6 rounded-lg transition flex items-center justify-center gap-3 shadow-md text-base sm:text-lg"
                >
      ...
      {!isAuthenticated && (
        <section className="py-6 sm:py-8 bg-gradient-to-br from-blue-50 to-indigo-50 border-b">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-4 sm:p-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-4">
              ...
              <div className="flex flex-wrap gap-2 w-full sm:w-auto">
                <button
                  ...
                  className={`px-4 py-3 rounded-md font-medium transition w-full sm:w-auto ${
                ...
                {[5, 4, 3, 2, 1].map((rating) => (
                  <button
                    ...
                    className={`px-4 py-3 rounded-md font-medium transition flex items-center gap-2 w-full sm:w-auto justify-center ${
