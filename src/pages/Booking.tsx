        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-12">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-gray-50 rounded-lg shadow-md border border-gray-200 p-4 sm:p-6">
                <h3 className="text-xl sm:text-2xl font-semibold mb-4">What to Expect</h3>
              ...
              <div className="bg-blue-50 rounded-lg shadow-md border border-blue-100 p-4 sm:p-6">
              ...
              <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4 sm:p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl sm:text-2xl font-semibold">Scheduled Appointments</h3>
                </div>
                {loadingBookings ? (
